...
import {corroboratedGenres} from '../lib/genres.ts';
...
export function hardcoverRecord(row:Row){
 ...
 sourceGenreLabels:genres,description:description||'No synopsis supplied by this catalog.',genres:corroboratedGenres(genres,tags),tags:extractTags(description,[...genres,...moods,...tags]),
